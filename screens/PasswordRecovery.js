...
function PasswordRecovery({ navigation }) {
  const [isSent, setIsSent] = React.useState(false);
    if (isSent == true){
      return ( <ActionScreen navigation={navigation} page_name="Sign Up" title="Mail Sent Successfully" subtitle="Please, visit your mailbox to follow the password" button_text="Ok" next_screen="Log In" />)
